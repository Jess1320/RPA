...
Descarga archivos mensuales de Tele Urgencia desde ExplotaDatos para las IPRESS marcadas en Google Sheets.

Este RPA viene de la ruta local historica `D:\RPA_TELE_URGENCIA` y queda preparado para pruebas en QA antes de pasar a produccion.

## Datos principales

| Campo | Valor |
| --- | --- |
| Codigo del job | `TELE_URGENCIA` |
| Sistema origen | ESSI / ExplotaDatos |
| Fuente funcional | Google Sheets |
| Salida principal | `PacAtendxTopico.txt` |
| Frecuencia actual | Diaria en madrugada |
| Hora local actual | 06:00 |
...
6. Navega al formulario de Tele Urgencia.
