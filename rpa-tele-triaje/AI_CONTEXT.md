# Contexto para IA - RPA Tele Triaje

Leer este archivo antes de modificar el RPA.

## Objetivo

Descargar el archivo mensual de Tele Triaje desde ExplotaDatos para los centros marcados en Google Sheets.
...
scripts/run_rpa_tele_triaje.sh
src/RPA_TELE_TRIAJE.py
```
