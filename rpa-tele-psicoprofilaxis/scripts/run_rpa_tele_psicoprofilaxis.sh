...
SCRIPT_PATH="$PROJECT_DIR/src/RPA_TELE_PSICOPROFILAXIS.py"
LOCK_DIR="${LOCK_DIR:-/tmp/rpa_tele_psicoprofilaxis.lock}"
...
echo "============================================================"
echo "$(date '+%F %T') | ORCH_START | RPA_TELE_PSICOPROFILAXIS"
